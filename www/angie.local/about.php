...
<div class="main">
    ...
    <div class="content">
        ...
        <section id="amp-manager" class="card">
            <h2>AMP Manager</h2>
            <p>The AMP Manager (<code>amp-manager.bat</code>) is the central tool for creating, configuring and removing local sites on your machine.</p>
            <p>It handles:</p>
            <ul>
                <li>Project folder creation in <code>D:\amp\www\</code></li>
        ...
        <section id="angie-server" class="card">
            ...
            <p>More technical details and customization options will be added here later.</p>
        </section>
        ...
        <section id="mariadb" class="card">
            ...
            <p>Use phpMyAdmin or any MySQL client to manage databases.</p>
        </section>
        ...
        <section id="utils-tools" class="card">
            ...
            <ul>
                <li>mkcert — local SSL certificates (trusted by browsers after install)</li>
                <li>amp-manager.bat — site creation/removal script</li>
                <li>Optional: Acrylic DNS Proxy (wildcard *.local resolution)</li>
            </ul>
            <br/>
            <h2>Admin DB</h2>
            <p>Admin DB is a lightweight database management tool built into AMP.</p>
            <p>It provides a simple interface to manage MariaDB databases and tables.</p>
            <p><a href="adminneo/index.php">Admin DB →</a></p>
            <br/>
