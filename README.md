...
**AMP-MANAGER.bat** is set to CP850, but encoded with Estonian ISO 8859-13 characters, and ANSI color sequences to render the UI. Microsoft as _automated_ its Terminal on Windows 11, making the console host switch code pages or rendering modes the breaks the UI.    
